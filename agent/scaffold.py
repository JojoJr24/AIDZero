...
class AgentScaffolder:
    ...
    def scaffold(
        ...
        *,
        ...
        copied = self._copy_environment_folders(destination=resolved_destination)
        copied.extend(self._copy_runtime_agent_support(destination=resolved_destination))
        copied.append(
    ...
    def _copy_environment_folders(self, *, destination: Path) -> list[Path]:
        copied: list[Path] = []
    ...
    def _copy_runtime_agent_support(self, *, destination: Path) -> list[Path]:
